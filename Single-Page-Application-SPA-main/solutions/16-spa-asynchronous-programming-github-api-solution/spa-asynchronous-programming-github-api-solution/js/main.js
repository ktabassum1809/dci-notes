...
class GithubApiWidget {
  ...
  init() {
    ...
    this.elements.form = this.elements.container.querySelector(
      ".github-widget-form"
    );
    this.elements.input = this.elements.container.querySelector(
      ".github-widget-input"
    );
    this.elements.list = this.elements.container.querySelector(
      ".github-widget-repositories"
    );
  ...
  getRepositories(username, callback) {
    ...
    const url = `${this.apiUrl}${this.userRepositoriesEndpoint}`.replace(
      ":username",
